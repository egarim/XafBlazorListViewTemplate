...
namespace XafBlazorListViewTemplate.Blazor.Server {
    public partial class XafBlazorListViewTemplateBlazorApplication : BlazorApplication {
        public XafBlazorListViewTemplateBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafBlazorListViewTemplateBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
