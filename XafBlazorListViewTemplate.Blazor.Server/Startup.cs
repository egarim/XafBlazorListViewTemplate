...
using XafBlazorListViewTemplate.Blazor.Server.Services;
...
namespace XafBlazorListViewTemplate.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<XafBlazorListViewTemplateBlazorApplication>(Configuration);
            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "XafBlazorListViewTemplate API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the XafBlazorListViewTemplate.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
            if(env.IsDevelopment()) {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "XafBlazorListViewTemplate WebApi v1");
                });
            }
            else {
